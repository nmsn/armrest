import { Code, Wrench, Palette, Users, Bookmark as BookmarkIcon, Folder, Star, Sparkles, Pencil, Trash2 } from "lucide-react"
...
function SortableFolderItem({ folder, index, isActive, onSelect, onEdit, onDelete }: SortableFolderItemProps) {
  const {
    isOver,
    isDragging,
    attributes,
...
export function FolderList({ folders, activeIndex, onSelect, onEdit, onDelete }: FolderListProps) {
