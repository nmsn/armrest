  ...
  DEFAULT_FOLDERS: [
    ...
    { name: 'Design', icon: 'palette', color: '#F59E0B', bookmarks: [] },
    {
      name: 'AI', icon: 'sparkles', color: '#8B5CF6', bookmarks: [
        { name: 'Grok', url: 'https://x.com/i/grok', color: '#000000' },
        { name: 'Claude', url: 'https://claude.ai', color: '#D97706' },
        { name: 'GLM', url: 'https://www.zhipuai.cn/', color: '#7C3AED' },
        { name: 'DeepSeek', url: 'https://www.deepseek.com/', color: '#3B82F6' },
        { name: 'DeepWiki', url: 'https://deepwiki.com/', color: '#10B981' },
        { name: 'Skills.sh', url: 'https://skills.sh/', color: '#EF4444' },
      ]
    },
  ],
  FOLDER_COLORS: [
